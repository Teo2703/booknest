...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '8fe91486-69ad-11f1-a255-c21288bad039:1-142';
...
INSERT INTO `order_items` VALUES (1,4,4,1,39.90),(2,5,15,1,25.00),(3,5,17,2,28.90),(4,6,2,1,58.00),(5,6,11,1,42.00),(6,7,9,1,60.00),(7,7,16,1,31.90),(8,8,15,1,25.00),(9,8,16,1,31.90),(10,9,16,1,31.90),(11,10,17,1,28.90);
...
CREATE TABLE `orders` (
  ...
  `status` enum('Pending','Processing','Completed','Cancelled','Refunded') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Pending',
...
INSERT INTO `orders` VALUES (2,3,42.90,'Cancelled','2026-05-13 17:04:34','Pending',NULL,NULL,NULL),(4,4,44.90,'Pending','2026-06-15 08:33:21','Pending',NULL,NULL,NULL),(5,2,82.80,'Completed','2026-06-16 19:34:40','Pending',NULL,NULL,NULL),(6,2,100.00,'Cancelled','2026-06-20 09:44:32','Pending',NULL,NULL,NULL),(7,2,91.90,'Refunded','2026-06-21 06:26:14','Pending',NULL,NULL,NULL),(8,3,61.90,'Completed','2026-06-21 07:04:35','Pending',NULL,NULL,NULL),(9,3,36.90,'Pending','2026-06-21 07:26:05','Pending',NULL,NULL,NULL),(10,2,33.90,'Refunded','2026-06-21 07:28:05','Pending',NULL,NULL,NULL);
...
-- Dump completed on 2026-06-21 20:47:20
